...
cuts['ZmmCR'] = tAND(cuts['ZmmINC'],'(nLooseElectron+nLoosePhoton+nTau)==0 && calocutZ<0.5 && pfUZmag>250 && dphipfUZ>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5')
cuts['ZeeCR'] = tAND(cuts['ZeeINC'],'(nLooseMuon+nLoosePhoton+nTau)==0 && calocutZ<0.5 && pfUZmag>250 && dphipfUZ>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5')
cuts['WmnCR'] = tAND(cuts['WmnINC'],'(nLooseElectron+nLoosePhoton+nTau)==0 && calocutW<0.5 && pfUWmag>250 && dphipfUW>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5')
cuts['WenCR'] = tAND(cuts['WenINC'],'(nLooseMuon+nLoosePhoton+nTau)==0 && calocutW<0.5 && pfUWmag>250 && dphipfUW>0.5 && jet1Pt>100 && abs(jet1Eta)<2.5')
